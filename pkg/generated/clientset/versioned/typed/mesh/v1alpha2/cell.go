...
func newCells(c *MeshV1alpha2Client, namespace string) *cells {
	return &cells{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *cells) Get(name string, options v1.GetOptions) (result *v1alpha2.Cell, err error) {
	result = &v1alpha2.Cell{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cells").
		Name(name).
...
func (c *cells) List(opts v1.ListOptions) (result *v1alpha2.CellList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.CellList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("cells").
...
func (c *cells) Create(cell *v1alpha2.Cell) (result *v1alpha2.Cell, err error) {
	result = &v1alpha2.Cell{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("cells").
...
func (c *cells) Update(cell *v1alpha2.Cell) (result *v1alpha2.Cell, err error) {
	result = &v1alpha2.Cell{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cells").
...
func (c *cells) UpdateStatus(cell *v1alpha2.Cell) (result *v1alpha2.Cell, err error) {
	result = &v1alpha2.Cell{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("cells").
...
func (c *cells) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Cell, err error) {
	result = &v1alpha2.Cell{}
