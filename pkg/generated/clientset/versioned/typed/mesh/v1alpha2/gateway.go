...
func newGateways(c *MeshV1alpha2Client, namespace string) *gateways {
	return &gateways{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *gateways) Get(name string, options v1.GetOptions) (result *v1alpha2.Gateway, err error) {
...
func (c *gateways) List(opts v1.ListOptions) (result *v1alpha2.GatewayList, err error) {
...
func (c *gateways) Create(gateway *v1alpha2.Gateway) (result *v1alpha2.Gateway, err error) {
	result = &v1alpha2.Gateway{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Update(gateway *v1alpha2.Gateway) (result *v1alpha2.Gateway, err error) {
	result = &v1alpha2.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) UpdateStatus(gateway *v1alpha2.Gateway) (result *v1alpha2.Gateway, err error) {
	result = &v1alpha2.Gateway{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("gateways").
...
func (c *gateways) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Gateway, err error) {
	result = &v1alpha2.Gateway{}
