...
var gatewaysResource = schema.GroupVersionResource{Group: "mesh.cellery.io", Version: "v1alpha2", Resource: "gateways"}

var gatewaysKind = schema.GroupVersionKind{Group: "mesh.cellery.io", Version: "v1alpha2", Kind: "Gateway"}
...
func (c *FakeGateways) UpdateStatus(gateway *v1alpha2.Gateway) (*v1alpha2.Gateway, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(gatewaysResource, "status", c.ns, gateway), &v1alpha2.Gateway{})
