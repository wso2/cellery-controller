...
var cellsResource = schema.GroupVersionResource{Group: "mesh.cellery.io", Version: "v1alpha2", Resource: "cells"}

var cellsKind = schema.GroupVersionKind{Group: "mesh.cellery.io", Version: "v1alpha2", Kind: "Cell"}
...
func (c *FakeCells) Get(name string, options v1.GetOptions) (result *v1alpha2.Cell, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(cellsResource, c.ns, name), &v1alpha2.Cell{})

	if obj == nil {
		return nil, err
	}
	return obj.(*v1alpha2.Cell), err
}
...
func (c *FakeCells) List(opts v1.ListOptions) (result *v1alpha2.CellList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(cellsResource, cellsKind, c.ns, opts), &v1alpha2.CellList{})
	...
	list := &v1alpha2.CellList{ListMeta: obj.(*v1alpha2.CellList).ListMeta}
	for _, item := range obj.(*v1alpha2.CellList).Items {
...
func (c *FakeCells) Create(cell *v1alpha2.Cell) (result *v1alpha2.Cell, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(cellsResource, c.ns, cell), &v1alpha2.Cell{})
...
func (c *FakeCells) Update(cell *v1alpha2.Cell) (result *v1alpha2.Cell, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(cellsResource, c.ns, cell), &v1alpha2.Cell{})
...
func (c *FakeCells) UpdateStatus(cell *v1alpha2.Cell) (*v1alpha2.Cell, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(cellsResource, "status", c.ns, cell), &v1alpha2.Cell{})
...
func (c *FakeCells) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(cellsResource, c.ns, name), &v1alpha2.Cell{})
...
func (c *FakeCells) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &v1alpha2.CellList{})
	return err
}
...
func (c *FakeCells) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha2.Cell, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(cellsResource, c.ns, name, pt, data, subresources...), &v1alpha2.Cell{})
