	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MeshV1alpha2().Cells(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeshV1alpha2().Cells(namespace).Watch(options)
			},
		},
		&meshv1alpha2.Cell{},
		resyncPeriod,
...
func (f *cellInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&meshv1alpha2.Cell{}, f.defaultInformer)
}

func (f *cellInformer) Lister() v1alpha2.CellLister {
	return v1alpha2.NewCellLister(f.Informer().GetIndexer())
}
