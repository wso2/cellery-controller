...
import (
	...
	vickv1alpha1 "github.com/wso2/product-vick/pkg/apis/vick/v1alpha1"
	versioned "github.com/wso2/product-vick/pkg/client/clientset/versioned"
	internalinterfaces "github.com/wso2/product-vick/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/wso2/product-vick/pkg/client/listers/vick/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VickV1alpha1().Cells(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VickV1alpha1().Cells(namespace).Watch(options)
			},
		},
		&vickv1alpha1.Cell{},
		resyncPeriod,
...
func (f *cellInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vickv1alpha1.Cell{}, f.defaultInformer)
}
