...
type CompositeInformer interface {
	...
	Lister() v1alpha1.CompositeLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MeshV1alpha1().Composites(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MeshV1alpha1().Composites(namespace).Watch(options)
			},
		},
		&meshv1alpha1.Composite{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *compositeInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&meshv1alpha1.Composite{}, f.defaultInformer)
}

func (f *compositeInformer) Lister() v1alpha1.CompositeLister {
	return v1alpha1.NewCompositeLister(f.Informer().GetIndexer())
}
