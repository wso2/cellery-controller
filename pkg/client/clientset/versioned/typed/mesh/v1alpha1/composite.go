...
type CompositeInterface interface {
	Create(*v1alpha1.Composite) (*v1alpha1.Composite, error)
	Update(*v1alpha1.Composite) (*v1alpha1.Composite, error)
	UpdateStatus(*v1alpha1.Composite) (*v1alpha1.Composite, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1alpha1.Composite, error)
	List(opts v1.ListOptions) (*v1alpha1.CompositeList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Composite, err error)
	CompositeExpansion
}
...
func newComposites(c *MeshV1alpha1Client, namespace string) *composites {
	return &composites{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *composites) Get(name string, options v1.GetOptions) (result *v1alpha1.Composite, err error) {
...
func (c *composites) List(opts v1.ListOptions) (result *v1alpha1.CompositeList, err error) {
...
func (c *composites) Create(composite *v1alpha1.Composite) (result *v1alpha1.Composite, err error) {
	result = &v1alpha1.Composite{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("composites").
...
func (c *composites) Update(composite *v1alpha1.Composite) (result *v1alpha1.Composite, err error) {
	result = &v1alpha1.Composite{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("composites").
...
func (c *composites) UpdateStatus(composite *v1alpha1.Composite) (result *v1alpha1.Composite, err error) {
	result = &v1alpha1.Composite{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("composites").
...
func (c *composites) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Composite, err error) {
	result = &v1alpha1.Composite{}
