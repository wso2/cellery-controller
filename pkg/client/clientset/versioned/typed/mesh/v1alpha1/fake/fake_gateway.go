...
var gatewaysResource = schema.GroupVersionResource{Group: "mesh", Version: "v1alpha1", Resource: "gateways"}

var gatewaysKind = schema.GroupVersionKind{Group: "mesh", Version: "v1alpha1", Kind: "Gateway"}
