...
import (
	v1alpha1 "github.com/wso2/product-vick/system/ingress-controller/pkg/apis/vick/ingress/v1alpha1"
	"github.com/wso2/product-vick/system/ingress-controller/pkg/client/clientset/versioned/scheme"
...
// VickV1alpha1Client is used to interact with features provided by the vick.wso2.com group.
type VickV1alpha1Client struct {
	restClient rest.Interface
}

func (c *VickV1alpha1Client) Ingresses(namespace string) IngressInterface {
