...
import (
	...
	ingressv1alpha1 "github.com/wso2/product-vick/system/ingress-controller/pkg/apis/vick/ingress/v1alpha1"
	versioned "github.com/wso2/product-vick/system/ingress-controller/pkg/client/clientset/versioned"
	internalinterfaces "github.com/wso2/product-vick/system/ingress-controller/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/wso2/product-vick/system/ingress-controller/pkg/client/listers/ingress/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VickV1alpha1().Ingresses(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VickV1alpha1().Ingresses(namespace).Watch(options)
			},
		},
		&ingressv1alpha1.Ingress{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *ingressInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&ingressv1alpha1.Ingress{}, f.defaultInformer)
}
