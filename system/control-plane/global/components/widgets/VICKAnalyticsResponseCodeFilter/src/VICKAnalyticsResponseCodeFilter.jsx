...
/**
 * VICKAnalyticsResponseCodeFilter which renders the perspective and filter in response code analytics page
 */
class VICKAnalyticsResponseCodeFilter extends Widget {
    constructor(props) {
        super(props);
        this.state = {
...
VICKAnalyticsResponseCodeFilter.propTypes = {
    classes: PropTypes.object.isRequired,
};
global.dashboard.registerWidget('VICKAnalyticsResponseCodeFilter', VICKAnalyticsResponseCodeFilter);
