...
DROP DATABASE IF EXISTS VICK_OBSERVABILITY_DB;
...
CREATE DATABASE VICK_OBSERVABILITY_DB CHARACTER SET latin1;
...
GRANT ALL ON VICK_OBSERVABILITY_DB.* TO 'DATABASE_USERNAME'@'%' IDENTIFIED BY 'DATABASE_PASSWORD';
